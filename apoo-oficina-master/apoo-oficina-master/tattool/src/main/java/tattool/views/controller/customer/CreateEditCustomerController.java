...
public class CreateEditCustomerController {
	...
	/*
	 * ?? NAO SEI COMO SERA O PREENCHIMENTO DE ALGUNS ATRIBUTOS, MAS JA CRIEI UMA
	 * LABEL DE ERRO PRA TODOS
	 */
	...
	public Customer MontaCustomer() {
		...
		customer.getAddress().setZipCode(
				!zipCode.getText().equals("") ? Integer.parseInt(zipCode.getText().replaceAll("-", "")) : null);
		return customer;
	}
